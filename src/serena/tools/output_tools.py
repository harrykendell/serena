...
from serena.tools.tools_base import Tool, ToolMarkerDoesNotRequireActiveProject, ToolMarkerExplicitResultPaging


class ReadToolOutputTool(Tool, ToolMarkerDoesNotRequireActiveProject, ToolMarkerExplicitResultPaging):
    """Reads one page from a retained oversized tool result."""

    _MAX_PAGE_CHARS = 20_000

    def apply(self, output_id: str, offset: int = 0, max_chars: int = 20_000) -> dict[str, object]:
        ...
        :return: native paging state and exact retained content
        """
