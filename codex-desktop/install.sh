...
for required in \
    ...
    "$CODEX_ROOT/features/serena-approval-notifications/feature.json" \
...
cp -a "$CODEX_ROOT/features/serena-approval-notifications" "$OVERLAY_ROOT/serena-approval-notifications"
...
printf '[serena] Enabled features: tray-usage, serena-approval-notifications, chat-effort-diagnostics\n'
